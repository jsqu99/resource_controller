  ...
  module Controller
    def self.included(subclass)
      subclass.class_eval do
        ...
        include LegacyResourceController::Actions
        ...
        ACTIONS.each do |action|
          class_scoping_reader action, FAILABLE_ACTIONS.include?(action) ? LegacyResourceController::FailableActionOptions.new : LegacyResourceController::ActionOptions.new
        end
