module LegacyResourceController
  ...
  autoload :Accessors,              'legacy_resource_controller/accessors'
  autoload :ActionOptions,          'legacy_resource_controller/action_options'
  autoload :Actions,                'legacy_resource_controller/actions'
  autoload :Base,                   'legacy_resource_controller/base'
  autoload :Controller,             'legacy_resource_controller/controller'
  autoload :FailableActionOptions,  'legacy_resource_controller/failable_action_options'
  autoload :Helpers,                'legacy_resource_controller/helpers'
  autoload :ResponseCollector,      'legacy_resource_controller/response_collector'
  autoload :Singleton,              'legacy_resource_controller/singleton'
...
class ActionController::Base
  ...
  def self.resource_controller(*args)
    include LegacyResourceController::Controller
  ...
  def self.actions(*opts)
    ...
    all_actions = (singleton? ? LegacyResourceController::SINGLETON_ACTIONS : LegacyResourceController::ACTIONS) - [:new_action] + [:new]
